	  ...
	  num_classes_(num_classes)
{
	try {
		...
		if (this->use_gpu == "dml") {
			obs_log(LOG_WARNING, "DirectML (DML) support is currently not available, falling back to CPU");
			obs_log(LOG_INFO, "Please check back later for DML support updates");
		}
#endif
